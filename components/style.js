    ...
    <style jsx global>
      {`
        ...
        @font-face {
          ...
          src: url('${prefix}relative-book-pro.eot?#iefix')
        ...
        @font-face {
          ...
          src: url('${prefix}relative-medium-pro.eot?#iefix')
              format('embedded-opentype'),
        ...
        @font-face {
          ...
          src: url('${prefix}relative-mono-11-pitch-pro.eot?#iefix')
              format('embedded-opentype'),
        ...
        @font-face {
          ...
          src: url('${prefix}relative-faux-book-pro.eot?#iefix')
              format('embedded-opentype'),
